...
class TestSlurmClient:
    ...
    def test_sacct_basic(self):
        ...
        expected_cmd = 'sacct --format JobID,JobName,Partition,Account,AllocCPUS,State,ExitCode'
        self.mock_ssh_client.execute_command.assert_called_once_with(expected_cmd)
    ...
    def test_sacct_with_parameters(self):
        ...
        expected_cmd = 'sacct --format JobID,JobName,State -j 12345 -u testuser -S 2023-01-01 -E 2023-12-31'
        self.mock_ssh_client.execute_command.assert_called_once_with(expected_cmd)
        assert result['success'] is True
